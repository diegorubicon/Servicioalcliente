...
Public Class rptCapacitaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Academic.Reporting.rptCapacitaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCapacitaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCapacitaciones = New rptCapacitaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
