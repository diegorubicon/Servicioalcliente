...
namespace Vendedores.BusinessObjects
{
    ...
    public class Vendedores : Dictionary<string, Vendedor>
    {
        ...
        public void Fill()
        {
            ...
            foreach (Vendedor v in db.SelectAll())
            {               
                base.Add(v.Id, v);
            }
        }
        public new Vendedor  this [string CodigoVendedor]
        {
            get
            {
                ...
                {
                    DataSource.DataExchange db = new DataSource.DataExchange(_cnnstr);
                    Vendedor v = db.Get(CodigoVendedor);
                    if ( v != null)
                        base.Add(v.Id,v);
