...
namespace Vendedores.DataAccess
{
    public class DataManager
    {
        ...
        public Entities.Vendedor Get(string CodigoVendedor)
        {
            using (SqlConnection db = new SqlConnection(_cnnstr))
            {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                        Entities.Vendedor v = new Entities.Vendedor();
        ...
        public IEnumerable<Entities.Vendedor> SelectAll()
        {
              StringBuilder query = new StringBuilder();
              query.Append("SELECT * ");
              query.Append("FROM vendedores ");               
        ...
        public IEnumerable<Entities.Vendedor> SelectWithSales()
        {
        ...
        public IEnumerable<Entities.Vendedor> SelectWithSales(int PeriodoInicio, int PeriodoCierre)
        {
        ...
        public IEnumerable<Entities.Vendedor> SelectByPeriodIncome(int Period)
        {
            StringBuilder query = new StringBuilder();
            query.Append("SELECT * ");
            query.Append("FROM vendedores ");
        ...
        public IEnumerable<Entities.Vendedor> SelectBySponsor(string SponsorCode)
        {
            StringBuilder query = new StringBuilder();
            query.Append("SELECT * ");
            query.Append("FROM vendedores ");
        ...
        private Entities.Vendedor ParseToVendedor(ref SqlDataReader reader)
        {
            Entities.Vendedor v = new Entities.Vendedor();
            Ubicaciones.DataAccess.SqlDataStorage ubidb = new Ubicaciones.DataAccess.SqlDataStorage(_cnnstr);
