...
Public Class rptEjecutivoVentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ServicioalCliente.rptEjecutivoVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEjecutivoVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEjecutivoVentas = New rptEjecutivoVentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
