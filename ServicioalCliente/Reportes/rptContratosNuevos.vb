...
Public Class rptContratosNuevos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ServicioalCliente.rptContratosNuevos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContratosNuevos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContratosNuevos = New rptContratosNuevos()
        rpt.Site = Me.Site
        Return rpt
    End Function
