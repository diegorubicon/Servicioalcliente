...
Public Class rptActivosInactivos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptActivosInactivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ServicioalCliente.rptActivosInactivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptActivosInactivos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActivosInactivos = New rptActivosInactivos()
        rpt.Site = Me.Site
        Return rpt
    End Function
